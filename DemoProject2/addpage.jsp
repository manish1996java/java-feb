...
<div id="container">
	...
	<form action="status.jsp" method="GET">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="vstaffno" aria-describedby="emailHelp" placeholder="Enter Name" name="staff" required>
	  </div>
	  <div class="form-group">
	    <label for="vtype">Vehicle</label>
	    <input type="text" class="form-control" id="vtype" aria-describedby="emailHelp" placeholder="Enter Name" name="type" required>
	  </div>
	  <div class="form-group">
	    <label for="vehicleno">Vehicle No</label>
	    <input type="text" class="form-control" id="vehicleno" aria-describedby="emailHelp" placeholder="Enter Name" name="vnumber" required>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="vsupportingdoc" aria-describedby="emailHelp" placeholder="Enter Name" name="doc" required>
	  </div>
	  <div class="form-group">
	    <label for="vcontact">Contact No</label>
	    <input type="text" class="form-control" id="vcontact" aria-describedby="emailHelp" placeholder="Enter Name" name="cnt" required>
	  </div>
	  <div class="form-group">
